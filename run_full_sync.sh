...
export SYNC_STOCK_LOCATIONS="${SYNC_STOCK_LOCATIONS:-0}"
export NEWS_LIMIT="${NEWS_LIMIT:-100}"
export NEWS_STOCK_LIMIT="${NEWS_STOCK_LIMIT:-5}"
export STOCK_LOCATION_LIMIT="${STOCK_LOCATION_LIMIT:-100}"
export STOCK_LOCATION_SLEEP="${STOCK_LOCATION_SLEEP:-1.2}"
...
echo "[stockgraph] stock locations: $SYNC_STOCK_LOCATIONS, limit: $STOCK_LOCATION_LIMIT, sleep: ${STOCK_LOCATION_SLEEP}s"
